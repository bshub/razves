<div id="cart" class="btn-group btn-block">
  <button type="button" data-toggle="dropdown" data-loading-text="<?php echo $text_loading; ?>" class="kl-cart-btn dropdown-toggle">
    <span class="cart-icon"> </span>
    
    
    <span id="cart-total" style="display: none;"><?php echo $text_items; ?></span>
  </button>
  <span  class="kl-top-number">
           
          <a href="tel:+7 (499) 136 68 38"> (499) 136 68 38</a> 
    </span>
